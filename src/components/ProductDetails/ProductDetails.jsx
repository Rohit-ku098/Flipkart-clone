...
function ProductDetails() {
  ...
  console.log(product)
  return (
    <div className=" mx-20 p-3 flex justify-start relative   bg-white">
      <div className="w-[35rem]  h-screen sticky top-14 flex ">
        <div className="flex flex-col  gap-2">
          {product.images.map((img, index) => (
            <div
              className=" w-16 p-1 hover:border-2 border-[#2874F0]"
        ...
        <div>
          <div className=" mb-5 flex gap-10 font-Roboto">
            ...
            <div>
              <div className="w-fit border-b-2 border-[#2874F0] flex gap-2 items-center">
                ...
                />
                <p className="text-[#2874F0] cursor-pointer">check</p>
              </div>
              <div>
          ...
          <div className=" mb-5  flex gap-10 font-Roboto">
            ...
            <ul className="ms-4 list-disc marker:text-gray-400">
              ...
              <p className="text-[#0062ff] text-sm cursor-pointer">View Details</p>
            </ul>
          </div>
          <div className=" mb-5  flex gap-10 font-Roboto">
            ...
            <div className="flex flex-col">
              ...
              <ul className="ms-4 list-disc marker:text-gray-400 ">
                ...
                <p className="text-[#0062ff] text-sm cursor-pointer">See Other Options</p>
              </ul>
            </div>
          </div>
          <div className='w-80 m-6'>
            <img src="/Flipkart-clone/images/ProductDetails/superCoin.png" className='max-h-full max-w-full' alt="" />
          </div>
          <div className=" mb-5  flex  gap-10 font-Roboto">
            <h3 className="w-32 text-gray-500  ">Description</h3>
            <p className="w-full ms-4 ">
              {product.description}
